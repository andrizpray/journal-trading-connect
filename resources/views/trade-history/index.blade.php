                ...
                <table class="w-full text-xs sm:text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="table-row-hover border-t" style="border-color: var(--border-color);">
                            ...
                            <td class="py-2.5 text-right font-mono text-white">{{ format_trade_price($trade->open_price, $trade->currency_pair, $trade->tradingAccount) }}</td>
                            <td class="py-2.5 text-right font-mono text-white">{{ format_trade_price($trade->close_price, $trade->currency_pair, $trade->tradingAccount) }}</td>
